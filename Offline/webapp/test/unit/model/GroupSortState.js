sap.ui.define([
	"com/offline/Offline/model/GroupSortState",
	...
	QUnit.test("Should always return a sorter when sorting", function (assert) {
		...
		assert.strictEqual(this.oGroupSortState.sort("Lgnum").length, 1, "The sorting by Lgnum returned a sorter");
	});
	...
	QUnit.test("Should set the grouping to None if the user sorts by Lgnum and there was a grouping before", function (assert) {
		// Arrange
		this.oModel.setProperty("/groupBy", "");

		this.oGroupSortState.sort("Lgnum");
