/*global history */
sap.ui.define([
	"com/offline/Offline/controller/BaseController",
	"sap/ui/model/json/JSONModel",
	"sap/ui/model/Filter",
	"sap/ui/model/FilterOperator",
	"sap/m/GroupHeaderListItem",
	"sap/ui/Device",
	"com/offline/Offline/model/formatter",
	"sap/m/MessageBox"
], function (BaseController, JSONModel, Filter, FilterOperator, GroupHeaderListItem, Device, formatter, MessageBox) {
	"use strict";

	return BaseController.extend("com.offline.Offline.controller.Master", {
		...
		onSearch: function (oEvent) {
			...
			if (sQuery) {
				this._oListFilterState.aSearch = [new Filter("Lgnum", FilterOperator.Contains, sQuery)];
			} else {
				...
				function (mParams) {
					...
					if (!mParams.list.getSelectedItem()) {
						this.getRouter().navTo("object", {
							Tanum: encodeURIComponent(mParams.firstListitem.getBindingContext().getProperty("Tanum"))
						}, true);
					}
				}.bind(this),
				function (mParams) {
		...
		_showDetail: function (oItem) {
			...
			this.getRouter().navTo("object", {
				Tanum: encodeURIComponent(oItem.getBindingContext().getProperty("Tanum"))
			}, bReplace);
		},
