...
sap.ui.define([
	...
	return BaseController.extend("com.offline.Offline.controller.Detail", {
		...
		onDelete: function () {
			...
			var oViewModel = this.getModel("detailView"),
				...
				sObjectHeader = this._oODataModel.getProperty(sPath + "/Lgnum"),
		...
		_onObjectMatched: function (oEvent) {
			...
			this.getModel().metadataLoaded().then(function () {
				var sObjectPath = this.getModel().createKey("TransferOrderSet", oParameter);
		...
		_onBindingChange: function () {
			...
			var sPath = oElementBinding.getBoundContext().getPath(),
				...
				sObjectId = oObject.Tanum,
				sObjectName = oObject.Lgnum;
