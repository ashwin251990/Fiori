sap.ui.define([
	...
	return BaseController.extend("com.offline.Offline.controller.CreateEntity", {
		...
		_onCreate: function (oEvent) {
			...
			var oContext = this._oODataModel.createEntry("TransferOrderSet", {
		...
		_fnEntityCreated: function (oData) {
			var sObjectPath = this.getModel().createKey("TransferOrderSet", oData);
