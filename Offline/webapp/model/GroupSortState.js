sap.ui.define([
	...
	return BaseObject.extend("com.offline.Offline.model.GroupSortState", {
		 ...
		 * @class
		 * @public
		 * @alias com.offline.Offline.model.GroupSortState
		 */
		...
		group: function (sKey) {
			...
			if (sKey === "") {
				...
				this._oViewModel.setProperty("/sortBy", "Lgnum");
			}
